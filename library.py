...
class MediaDatebase(gobject.GObject, Logger):
    ...
    def load(self):        
        ...
        try:
            ...
            utils.saveJsonDB(db_objs, os.path.join(os.getcwd(), 'data', 'songs.json'))
        except:    
        ...
        try:    
            ...
            utils.saveJsonDB(pls_objs, os.path.join(os.getcwd(), 'data', 'playlists.json'))
        except:    
